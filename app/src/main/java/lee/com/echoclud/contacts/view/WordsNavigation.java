package lee.com.echoclud.contacts.view;
...
public class WordsNavigation extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            if (touchIndex == i) {
                //绘制文字圆形背景
                canvas.drawCircle(itemWidth / 2, itemHeight / 2 + i * itemHeight + itemHeight / 4 + 20, 7, bgPaint);
            ...
            float wordY = itemWidth / 2 + i * itemHeight + 20;
